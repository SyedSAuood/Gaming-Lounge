...
const SellOrder = () => {
    ...
    return (
        <div className="max-w-screen-lg mx-auto bg-form-bg rounded-lg shadow-lg p-8 ">
            <h1 className="[font-family:'Barlow-Bold',Helvetica] font-bold text-white text-[22px] tracking-[0.15px] leading-[27px] whitespace-nowrap">Sell an Account</h1>
            <div className="flex justify-between items-end ">
                <form className='flex flex-col '>
                    <div className='mr-2 ml-2 '>
                        {/* <label>Game Title:</label> */}
                        <select className=" text-black placeholder-gray-600 w-full px-4 py-2.5 mt-2 text-base   transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-200  focus:border-blueGray-500 focus:bg-white focus:outline-none focus:shadow-outline focus:ring-2 ring-gray-400"
                    ...
                    <div className="[font-family:'Barlow-Bold',Helvetica] font-bold mt-2 ml-2 text-white ">
                        Account Credentials
                    </div>
                    <div className=' mr-2 ml-2 flex' >
                        <input placeholder='Email' className='pr-2 text-black placeholder-gray-600 w-full px-4 py-2.5 mt-2 text-base   transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-200  focus:border-blueGray-500 focus:bg-white focus:outline-none focus:shadow-outline focus:ring-2 ring-gray-400"' 
                            type='email'
                            value={email}
                    ...
                    <div className='mt-2 mr-2 ml-2 flex' >
                        <input placeholder='Password' className='pr-2 text-black placeholder-gray-600 w-full px-4 py-2.5 mt-2 text-base   transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-200  focus:border-blueGray-500 focus:bg-white focus:outline-none focus:shadow-outline focus:ring-2 ring-gray-400"' 
                            type='password'
                            value={password}
