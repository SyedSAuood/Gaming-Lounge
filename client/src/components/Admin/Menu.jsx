    ...
    return (
      <div className="p-4">
        <div className=" flex justify-center">
          <div className="min-h-48 flex items-center justify-center bg-main-bg/50 rounded-md">
            {Ranking.map((item) => (
              <NavLink
                key={item.id}
